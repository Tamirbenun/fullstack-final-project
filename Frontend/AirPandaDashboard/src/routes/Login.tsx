...
const Login = () => {
  ...
  return (
    <main className="flex justify-center min-h-[90vh] md:px-10">
      <div className="bg-white rounded-2xl  w-full md:w-1/2 px-10 lg:px-20 pt-10">
        <div className="text-center">
          <h1 className="text-5xl font-medium mb-5 text-darkblue">Login</h1>
        </div>
        <Formik
          ...
          onSubmit={async (o) => {
            ...
            try {
              ...
              if (error.status === 404) {
                Swal.fire({
                  title: "Error",
                  text: "You do not have permission. Please contact the system administrator.",
                  icon: "error",
