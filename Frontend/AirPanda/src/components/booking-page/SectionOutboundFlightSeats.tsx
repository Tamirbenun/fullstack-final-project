...
import SeatsContainer from "../booking-page/SeatsContainer";
...
const SectionOutboundFlightSeats = () => {
  ...
  const handleStage = (dir: string): void => {
    if (dir === "next") {
      if (localStorage.getItem("SearchSwitch") === "Round Trip") {
  ...
  return (
    <section>
      <div className="text-center md:text-start">
        ...
        <p className="mb-5">Seat selection for outbound flight</p>
      </div>
      ...
      <div className="border rounded-3xl bg-gray-100">
        <div className="flex justify-around items-center m-5">
          <p className="text-2xl font-medium w-[60px]">
            {(() => {
              const departureTime = new Date(outboundFlight.departure);
          ...
          <div className="">
            <p className="text-sm font-medium text-center text-gray-400">
              {(() => {
                const flightTime = new Date(outboundFlight.flightTime);
        ...
        <div className="m-3 p-5 bg-white rounded-2xl">
          ...
          <SeatsContainer direction="Outbound" />
        </div>
      </div>
...
export default SectionOutboundFlightSeats;
